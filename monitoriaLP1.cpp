...
int main ()
{
    ...
    if (num% 15 == 0)
    {
        printf ("Esse número é divisível por 15");
    }
    outro
    {
        printf ("Esse número não é divisível por 15");
    }
...
int main ()
{
    ...
    {
    caso 1:
    printf ("Você deve fazer: Cálculo I, Geometria analítica ...");
    quebrar;
    caso 2:
    printf ("Voce deve fazer: calculo II, LP ...");
    quebrar;
    padrão:
    printf ("O número digitado não corresponde");
    }
